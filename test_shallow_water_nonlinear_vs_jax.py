...
so that the results must be close in double precision float64.
"""
...
from shallow_water_nonlinear_jax import iterate_shallow_water as iterate_shallow_water_jax
from shallow_water_nonlinear import iterate_shallow_water
...
def test_shallow_water_simple_vs_jax():
    ...
    # run both models for 100 time steps
    numer_of_time_steps = 100
